              ...
              <div className="lef__Side__form">
                <div className="input__Sections">
                  ...
                  <input
                    type="text"
                    value={menuCode}
                    onChange={(e) => setMenucode.apply(e.target.value)}
                  />
                </div>
                <div className="input__Sections">
                  <h5>Menu Name</h5>
                  <input
                    type="text"
                    value={menuName}
                    onChange={(e) => SetMenuName.apply(e.target.value)}
                  />
                </div>
                <div className="input__Sections priceInput">
                  ...
                  <input
                    type="text"
                    value={price}
                    onChange={(e) => setPrice.apply(e.target.value)}
                  />
                  <AddBoxOutlinedIcon
                ...
                <div className="drop__image__section">
                  <section className="container">
                    <div {...getRootProps({ className: "dropzone" })}>
                      ...
                      {editProduct && (
                        <img src={updatableProducts.Image} alt="" />
                      )}
                    </div>
