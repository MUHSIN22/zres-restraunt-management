    ...
    <>
      ...
      <div className="AccountLedger">
        <div className="headder__Section">
          <div className="left">
            <ArrowBackIcon onClick={() => SetClickedTr("")} />
            <h3>Account Ledger for the period of 22/11/2021 to 02/12/2021</h3>

            <div className="checkbox__Section">
              <input type="CheckBox"></input>
              <h5>Display Day Wise Balance</h5>
            </div>
          </div>
            ...
            <table className="table">
              ...
              <tbody>
                ...
                <tr>
                  <td></td>
                  <td></td>
                  <td style={{ color: "red", fontWeight: "bold" }} colspan="2">
                    Opening Balance
                  </td>
                  <td></td>
                  <td style={{ color: "red", fontWeight: "bold" }}>0.00</td>
                  <td></td>
                  <td></td>
                </tr>
                ...
                <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td style={{ color: "green", fontWeight: "bold" }}>8000</td>
                  <td></td>
                </tr>
                ...
                <tr>
                  ...
                  <td colspan="2"> </td>
                  <td></td>
                  <td style={{ color: "red", fontWeight: "bold" }}>8000</td>
                  <td style={{ color: "red", fontWeight: "bold" }}>8000</td>
                  <td></td>
                </tr>
              </tbody>
