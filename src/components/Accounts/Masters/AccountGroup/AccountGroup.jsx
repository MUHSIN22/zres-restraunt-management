...
function AccountGroup({ fetchALLAccountGroupList, accoutGroupList }) {
  ...
  const [editTableSelectedSnio, setEditTableSelctedSino] = useState(0);
  ...
  return (
    <>
      <div className="AccountGroup">
        ...
        {addNewBtn && (
          <AccountGroupAdd
            setEditTableSelctedSino={setEditTableSelctedSino}
            editTableSelectedSnio={editTableSelectedSnio}
            ...
            <div className="body__section">
              ...
              <div className="table__sectionsss">
                <table className="table">
                  ...
                  <tbody>
                    {dataFromServer.map((items) => (
                      <tr
                        style={{ cursor: "pointer" }}
                        onClick={() => {
                          setEditTableSelctedSino(items.accountGroupID);
