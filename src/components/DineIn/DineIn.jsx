          ...
          <div className="DineIn">
            ...
            <div className="Dinein__top__nav__section">
              <div className="left__dinein__section__nav">
                ...
                <div
                  className="dinein__nav__left__btn"
                  onClick={() => setFilterOption("mainArea")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="22.255"
                ...
                <div
                  className="dinein__nav__left__btn"
                  onClick={() => setFilterOption("patioArea")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="22.255"
                ...
                <div
                  className="dinein__nav__left__btn"
                  onClick={() => setFilterOption("familyArea")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="22.255"
              ...
              <div className="right__dinein__section__nav ">
                ...
                <button
                  ...
                  onClick={() => setSelectedAvialibilityTable("avilable__btn")}
                >
                  8 Available
                </button>
                <button
                  style={{ backgroundColor: "#c8c8cf", color: "#040153" }}
                  onClick={() => setSelectedAvialibilityTable("occupied__btn")}
                >
                  5 Occupied
                </button>
                <button
                  style={{ backgroundColor: "#040153", color: "#fff" }}
                  onClick={() => setSelectedAvialibilityTable("doneSoon__btn")}
                >
                  5 Done Soon
                </button>
                <button
                      ...
                      >
                        <div
                          className={
                            "table__background " +
                            ((filterOption === "all" && "") ||
                              (filterOption === "mainArea" &&
                                data.tablePlacement !== "mainArea" &&
                                "active ") ||
                              (filterOption === "patioArea" &&
                                data.tablePlacement !== "patioArea" &&
                                "active ") ||
                              (filterOption === "familyArea" &&
                                data.tablePlacement !== "familyArea" &&
                                "active "))
                          }
                        >
                          {data.tableType === "4Seater" && (
                            <div className="4seater__table tableInResturent">
                              <svg
                                style={
                                  data.tableInfo === "avilable__btn" && {
                                    stroke: "#009751",
                                    fill: "#009751",
                                  }
                                }
            ...
            <div className="bottom__nav__section">
              ...
              <div className="left__dinein__section__nav">
                ...
                <div
                  ...
                  style={{ backgroundColor: "#E1870E", width: "calc(100%/3)" }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="25.531"
